...
export default function EstudianteDashboard() {
  ...
  return (
    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#F4F6F9' }}>
      ...
      {/* Sidebar */}
      <aside
        className={`w-64 flex-shrink-0 flex flex-col fixed md:static inset-y-0 left-0 z-50 transition-transform md:translate-x-0 ${menuMovilAbierto ? 'translate-x-0' : '-translate-x-full'}`}
